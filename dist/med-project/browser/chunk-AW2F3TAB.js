...
// src/app/BookingManagement/Booking/BookingLayout/booking-layout.component.ts
var _c0 = () => ({ exact: true });
var BookingLayoutComponent = class _BookingLayoutComponent {
  router;
  ...
  static \u0275fac = function BookingLayoutComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BookingLayoutComponent)(\u0275\u0275directiveInject(Router));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookingLayoutComponent, selectors: [["app-booking-layout"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 27, vars: 3, consts: [[1, "app-shell"], [1, "main-content"], [1, "page-container"], [1, "breadcrumb"], [1, "breadcrumb-arrow"], [1, "breadcrumb-current"], [1, "tabs"], ["routerLink", "/booking", "routerLinkActive", "active", 1, "tab", 3, "routerLinkActiveOptions"], [1, "material-icons"], ["routerLink", "/booking/appointment-list", "routerLinkActive", "active", 1, "tab"]], template: function BookingLayoutComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275text(21, " Book Appointment ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(22, "button", 9)(23, "i", 8);
      \u0275\u0275text(24, "list_alt");
      \u0275\u0275elementEnd();
      \u0275\u0275text(25, " Appointment List ");
      \u0275\u0275elementEnd()();
